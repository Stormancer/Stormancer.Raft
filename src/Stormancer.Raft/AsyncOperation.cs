...
namespace Stormancer.Threading
{
    public abstract class AsyncOperation
    {
        ...
        protected static void ThrowIncompleteOperationException() =>
            throw new InvalidOperationException("Incomplete async operation.");
        ...
        protected static void ThrowMultipleContinuations() =>
            throw new InvalidOperationException("Only supports a single continuation.");
        ...
        protected static void ThrowIncorrectCurrentIdException() =>
            throw new InvalidOperationException("Operation used after it was invalidated.");
    }
    ...
    public partial class AsyncOperation<TResult> : AsyncOperation, IValueTaskSource, IValueTaskSource<TResult>
    {
        ...
        public bool TryOwnAndReset()
        {
            ...
            // If _continuation == s_availableSentinel => _continuation = null
    ...
    public sealed class AsyncOperationWithData<TData,T> : AsyncOperation<T>
    {
        /// <summary>Initializes the interactor.</summary>
        /// <param name="runContinuationsAsynchronously">true if continuations should be forced to run asynchronously; otherwise, false.</param>
        /// <param name="cancellationToken">The cancellation token used to cancel the operation.</param>
        /// <param name="pooled">Whether this instance is pooled and reused.</param>
        public AsyncOperationWithData(bool runContinuationsAsynchronously, CancellationToken cancellationToken = default, bool pooled = false) :
    ...
    public partial class AsyncOperation<TResult> : IThreadPoolWorkItem
    {
    ...
    public class AsyncOperationWithDataPoolPolicy<TData,TResult> : IPooledObjectPolicy<AsyncOperationWithData<TData, TResult>>
    {
    ...
    public class AsyncOperationPoolPolicy<TResult> : IPooledObjectPolicy<AsyncOperation<TResult>>
    {
        public AsyncOperation< TResult> Create()
        {
            var op = new AsyncOperation< TResult>(true, default, true);
            op.TryOwnAndReset();
            return op;
        }

        public bool Return(AsyncOperation< TResult> obj)
        {
            return obj.TryOwnAndReset();
        }
    }
